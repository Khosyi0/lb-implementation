...
class BackendList:
    def __init__(self):
        self.servers=[]
        self.servers.append(('127.0.0.1',7000))
        self.servers.append(('127.0.0.1',7001))
        self.servers.append(('127.0.0.1',7002))
        self.servers.append(('127.0.0.1',7003))
        self.current=0
    def getserver(self):
...
class Server(asyncore.dispatcher):
    ...
    def handle_accept(self):
        ...
        if pair is not None:
            ...
            logging.warning("connection from {} is forwarded to {}".format(addr, bs))
            backend = Backend(bs)
